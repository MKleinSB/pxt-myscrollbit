//% weight=100 color=#000000 icon="\uf06e" block="MyScroll:Bit"
namespace myscrollbit {
     ...
     */
    //% blockId=myscrollbit_upside_down
     ...
     */
    //% blockId=myscrollbit_get_pixel icon="\uf0eb"
