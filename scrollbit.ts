...
namespace myscrollbit {
    ...
    /**
      ...
      */
    //% blockID=myscrollbit_frame_blink
    ...
    /**
      ...
      */
    //% blockId=myscrollbit_frame_plot
     ...
     */
    //% blockId=myscrollbit_frame_scroll
     ...
     */
    //% blockId=myscrollbit_frame_clear
     ...
     */
    //% blockId=myscrollbit_frame_max_x
     ...
     * @param image - image to display
     */
    //% blockId=myscrollbit_set_full_image
    ...
    //% block="world: delete"
    //% blockId=myscrollbit_delete_world
    //% advanced=true color=#4703c3
    ...
    /**
      ...
      * @param y1 - row
      */
    //% blockId=myscrollbit_world_plot
     ...
     * @param y - row
     */
    //% blockId=myscrollbit_world_position_frame
     ...
     */
    //% blockId=myscrollbit_world_move_frame
     ...
     * @param y - row (0,7)
     */
    //% blockID=myscrollbit_world_is_pixel
     ...
     * @param y - row (0,7)
     */
    //% blockID=myscrollbit_world_is_pixel_relative
    ...
    //% blockId=myscrollbit_get_world_frame_x
    //% block="world: get frame position x"
    //% advanced=true color=#4703c3
    export function worldFramePosX(): number {
        return worldFrameX
    }
    //% blockId=myscrollbit_get_world_frame_y
    ...
    //% blockId=myscrollbit_world_frame_max_x
    //% block="world: frame position max x"
    //% advanced=true color=#4703c3
    export function worldFrameMaxX(): number {
        return wfMaxX
    }
    //% blockId=myscrollbit_world_frame_max_y
    ...
    */
     ...
     * @param x - column (0-17)
     */
    //% blockId=myscrollbit_frame_show_column
